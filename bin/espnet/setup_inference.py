...
if __name__=="__main__":
    """
    USAGE: python prepare_mp3_file_for_inference.py SAT20190524.mp3 --timestamps_txt_file SAT20190524.txt
    USAGE (this): python setup_inference.py /home/ubuntu/code/espnet/egs/Bapa/asr1 tmp_segments
    USAGE: python create_timestamped_transcripts.py /home/ubuntu/code/espnet/egs/Bapa/asr_exp_59/exp/train_nodev_pytorch_train_mtlalpha1.0/decode_inference_decode_ctcweight1.0_lm_word50000/result.txt tmp_segments/timestamps.txt --output_fname SAT20190524.may_10.output.jsonl
    """
    ##### ARGUMENTS #####
    DEST_DIR = sys.argv[1]
